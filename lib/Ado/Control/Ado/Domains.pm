...
Ado::Control::Ado::Domains - a controller for resource /ado-domains.
...
=head1 SYNOPSIS
  ...
  http://your-host/ado-domains/list
  #or
  http://your-host/ado-domains
  #and
  http://your-host/ado-domains/update/$id
  #and
  http://your-host/ado-domains/create


=head1 ATTRIBUTES

L<Ado::Control::Ado::Domains> inherits all the attributes from
L<Ado::Control::Ado>.

=head1 METHODS/ACTIONS

L<Ado::Control::Ado::Domains> inherits all methods from
...
Handles route C</ado-domains/create>.
Responds to HTTP methods GET and POST.
Supported MIME types are 'application/json' and 'text/html'.

=head2 list

Handles route C</ado-domains> and C</ado-domains-list>.
Responds to HTTP method GET.
Supported MIME types are 'application/json' and 'text/html'.

=head2 read

Handles route C</ado-domains/read/:id>.
Responds to HTTP method GET.
Supported MIME types are 'application/json' and 'text/html'.

=head2 update

Handles route C</ado-domains/update/:id>.
Responds to HTTP methods GET and PUT.
Supported MIME types are 'application/json' and 'text/html'.

=head2 delete

Handles route C</ado-domains/delete/:id>.
Responds to HTTP method GET and DELETE.
Supported MIME types are 'application/json' and 'text/html'.

=head1 SEE ALSO

L<Ado::Control::Ado::Pages>, L<Ado::Control::Ado>, L<Ado::Control>
